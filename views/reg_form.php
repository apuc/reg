...
<form method="post" id="user_form" class="rf">
        ...
        <p>Фамилия <br/><input id="lastName" type="text" class="rfield" name="lastName" pattern="[А-ЯЁ][а-яё]+" required placeholder="Фамилия"/></p>
        ...
        <p>Пол <br/><input type="radio" name="Sex" value="Мужской" checked="checked" required/> Мужской<br />
        ...
        <input type="button" class="btn_submit" id="send_user_info" value="Отправить"/>
</form>
